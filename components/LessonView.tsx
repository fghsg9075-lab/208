  ...
  if (content.type === 'NOTES_IMAGE_AI') {
      ...
      return (
          <div 
              ...
              style={{ touchAction: 'none' }} // Prevent swipes on the container itself mostly
          >
              ...
              <div 
                  className="flex-1 overflow-y-auto overflow-x-hidden bg-zinc-900 flex flex-col items-center w-full"
                  style={{ touchAction: 'pan-y' }} // ALLOW Vertical Scroll, BLOCK Pinch/Horizontal
                  onContextMenu={preventMenu}
              >
                  {/* Removed max-w-2xl to ensure FULL WIDTH on all screens per user request */}
                  <div className="w-full bg-zinc-900 min-h-screen pt-16 pb-20">
                      <img 
                          src={content.content} 
                          alt="AI Notes" 
                          ...
                          style={{ 
                              ...
                              touchAction: 'pan-y',
                              width: '100%' // Ensure width fits container
                          }}
                      />
                  </div>
                  
                  <div className="h-20 w-full flex items-center justify-center bg-zinc-900 text-zinc-600 text-xs font-mono pb-8">
                      -- END OF NOTES --
                  </div>
              </div>
          </div>
